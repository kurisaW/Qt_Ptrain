...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyThread2_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyThread2_t qt_meta_stringdata_MyThread2 = {
    {
QT_MOC_LITERAL(0, 0, 9), // "MyThread2"
QT_MOC_LITERAL(1, 10, 11), // "threadValue"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "UserData"
QT_MOC_LITERAL(4, 32, 3) // "val"

    },
    "MyThread2\0threadValue\0\0UserData\0val"
};
...
void MyThread2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->threadValue((*reinterpret_cast< UserData(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyThread2::*_t)(UserData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread2::threadValue)) {
                *result = 0;
            }
        }
    }
...
void *MyThread2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyThread2.stringdata))
...
// SIGNAL 0
void MyThread2::threadValue(UserData _t1)
{
